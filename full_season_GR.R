...
mod6 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
mod7 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
            + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = data)

mod8 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
            + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = data)

mod9 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
submod6 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
               + Titles + Majors + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

# Models 7-9 are Model 6 with alternative specifications for Majors and French_Open to serve as robustness checks

submod7 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
               + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

submod8 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
               + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

submod9 <- glm(Competed ~ factor(Gender) + Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
write.csv(stargazer(mod1, mod2, mod3, mod4, mod5, mod6, mod7, mod8, mod9, type = 'text', se = list(rse1, rse2, rse3, rse4, rse5, rse6, rse7, rse8, rse9)),
          paste(directory, 'results_all_full_season_rankX.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod1, submod2, submod3, submod4, submod5, submod6, submod7, submod8, submod9, type = 'text',
          ...
          paste(directory, 'results_lucky_full_season_rankX.txt', sep = ''), row.names = FALSE)

write.csv(stargazer(mod1, mod2, mod3, mod4, mod5, mod6, mod7, mod8, mod9,
                    se = list(rse1, rse2, rse3, rse4, rse5, rse6, rse7, rse8, rse9)),
          paste(directory, 'results_all_full_season_rankX_tex.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod1, submod2, submod3, submod4, submod5, submod6, submod7, submod8, submod9,
                    se = list(subrse1, subrse2, subrse3, subrse4, subrse5, subrse6, subrse7, subrse8, subrse9)),
          paste(directory, 'results_lucky_full_season_rankX_tex.txt', sep = ''), row.names = FALSE)
...
mod6m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = datam)

mod7m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = datam)

mod8m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = datam)

mod9m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
mod6f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = dataf)

mod7f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = dataf)

mod8f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
             + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = dataf)

mod9f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
submod6m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdatam)

submod7m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdatam)

submod8m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdatam)

submod9m <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
submod6f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdataf)

submod7f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors_Bi + Current + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdataf)

submod8f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
                + Titles + Majors + Current_Bi + factor(Event.Type) + Prev_Tourn_Comp, family = binomial(link = logit), data = subdataf)

submod9f <- glm(Competed ~ Age + Age2 + log(Winnings + 1) + log(Winnings_20 + 1) + Doubles + Qualifier + factor(Gender)*Ranking_S
...
write.csv(stargazer(mod2m, mod3m, mod4m, mod5m, mod6m, mod7m, mod8m, mod9m, type = 'text',
          ...
          paste(directory, 'results_all_full_season_M_rankX.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod2m, submod3m, submod4m, submod5m, submod6m, submod7m, submod8m, submod9m, type = 'text',
          ...
          paste(directory, 'results_lucky_full_season_M_rankX.txt', sep = ''), row.names = FALSE)

write.csv(stargazer(mod2m, mod3m, mod4m, mod5m, mod6m, mod7m, mod8m, mod9m,
                    se = list(rse2m, rse3m, rse4m, rse5m, rse6m, rse7m, rse8m, rse9m)),
          paste(directory, 'results_all_full_season_M_rankX_tex.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod2m, submod3m, submod4m, submod5m, submod6m, submod7m, submod8m, submod9m,
                    se = list(subrse2m, subrse3m, subrse4m, subrse5m, subrse6m, subrse7m, subrse8m, subrse9m)),
          paste(directory, 'results_lucky_full_season_M_rankX_tex.txt', sep = ''), row.names = FALSE)
...
write.csv(stargazer(mod2f, mod3f, mod4f, mod5f, mod6f, mod7f, mod8f, mod9f, type = 'text',
          ...
          paste(directory, 'results_all_full_season_F_rankX.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod2f, submod3f, submod4f, submod5f, submod6f, submod7f, submod8f, submod9f, type = 'text',
          ...
          paste(directory, 'results_lucky_full_season_F_rankX.txt', sep = ''), row.names = FALSE)

write.csv(stargazer(mod2f, mod3f, mod4f, mod5f, mod6f, mod7f, mod8f, mod9f,
                    se = list(rse2f, rse3f, rse4f, rse5f, rse6f, rse7f, rse8f, rse9f)),
          paste(directory, 'results_all_full_season_F_rankX_tex.txt', sep = ''), row.names = FALSE)
write.csv(stargazer(submod2f, submod3f, submod4f, submod5f, submod6f, submod7f, submod8f, submod9f,
                    se = list(subrse2f, subrse3f, subrse4f, subrse5f, subrse6f, subrse7f, subrse8f, subrse9f)),
          paste(directory, 'results_lucky_full_season_F_rankX_tex.txt', sep = ''), row.names = FALSE)
