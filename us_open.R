...
mod6 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
            + Injury + Ranking_S + Titles + Majors + US_Open + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = data)
...
mod7 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier 
            + Injury + Ranking_S + Titles + Majors_Bi + US_Open + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = data)

mod8 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
            + Injury + Ranking_S + Titles + Majors + US_Open_Bi + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = data)

mod9 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
            + Injury + Ranking_S + Titles + Majors_Bi + US_Open_Bi + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = data)
...
submod6 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
               + Injury + Ranking_S + Titles + Majors + US_Open + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

# Models 7-9 are Model 6 with alternative specifications for Majors and US_Open to serve as robustness checks

submod7 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier 
            + Injury + Ranking_S + Titles + Majors_Bi + US_Open + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

submod8 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
            + Injury + Ranking_S + Titles + Majors + US_Open_Bi + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)

submod9 <- glm(Competed ~ factor(Gender) + Age + log(Winnings) + log(Winnings_20 + 1) + Doubles + COVID + Suspension + Qualifier
            + Injury + Ranking_S + Titles + Majors_Bi + US_Open_Bi + Prev_Tourn_Res + Prev_Tourn_Comp, family = binomial(link = logit), data = subdata)
